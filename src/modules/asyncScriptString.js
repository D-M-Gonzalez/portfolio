const asyncScriptString = 
`function deleteItems(resultadoDiv){ //Función que borra los elementos existentes
...
function createItems (resultadoDiv){ //Función que crea los elementos
...
function animateItems (resultadoDiv){ //Función que anima la aparición
...
export default asyncScriptString;